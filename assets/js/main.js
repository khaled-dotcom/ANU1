...
function initChatbot() {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      errDiv.innerHTML = `<p>${
        currentLang === 'ar'
          ? 'عذراً، المساعد غير متاح حالياً. تأكد من إعداد مفتاح API في ملف config.js'
          : 'Sorry, the assistant is unavailable. Please ensure the API key is set in config.js'
      }</p>`;
